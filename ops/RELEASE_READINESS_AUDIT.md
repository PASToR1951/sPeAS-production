...
- Added hidden prompts and Docker-secret delivery for SMTP passwords.
- Added menu commands to rotate email configuration and administrator password
...
- Verify production DNS, inbound ports 80/443, Caddy certificate issuance, and
  reboot recovery.
- Verify password login and password reset for at least two administrators.
- Verify the institution's actual SMTP relay and deliver a message.
