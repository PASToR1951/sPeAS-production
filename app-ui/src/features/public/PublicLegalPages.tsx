...
const terms: LegalSection[] = [
  ...
  { title: "Account Registration and Security", paragraphs: ["To access certain features of the Service, you may be required to register for an account. You agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate, current, and complete. You are responsible for safeguarding your password and for all activities that occur under your account. You agree to notify PeAS immediately of any unauthorized use of your account."], bullets: ["Ensure your account information is accurate and up-to-date.", "Maintain the confidentiality of your account password.", "Report any suspected unauthorized account activity promptly."] },
...
const privacy: LegalSection[] = [
  { title: "What Information We Collect (and Why!)", paragraphs: ["To provide and improve our services, we may collect a smidgen of information. Here's the lowdown:"], subheading: "Information You Provide Directly:", bullets: ["Account Information: When you create an account, we ask for things like your name, email address, and affiliation. This helps us know who you are (it's not for sending spam, promise!).", "Uploaded Content: Any documents or data you upload for archiving or analysis. This is YOUR data, and we treat it with utmost respect.", "Communications: If you contact us, we'll keep a record of that chat to help you better next time."] },
  ...
  { title: "Your Rights & Choices (You're in Control!)", paragraphs: ["You have rights regarding your personal information:", "To exercise these rights, please contact us. We'll respond to your request in a timely manner."], bullets: ["Access & Update: You can review and update your account information through your profile settings.", "Data Portability: You may be able to request a copy of your information in a machine-readable format.", "Deletion: You can request deletion of your account and associated data, subject to certain exceptions (like legal obligations to retain data). Contact inquiries and administrator notes are retained indefinitely under the selected retention policy.", "Cookie Control: As mentioned, you can manage cookies via your browser settings.", "Opt-out of Communications: You can opt-out of promotional emails by following the unsubscribe instructions in those emails."] },
