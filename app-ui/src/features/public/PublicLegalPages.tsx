...
const terms: LegalSection[] = [
  ...
  { title: "Public Document Downloads", paragraphs: ["Visitors do not create PeAS accounts. Documents published in the public repository may be opened and downloaded immediately from their detail pages without submitting identity or contact information."], bullets: ["Use downloaded research responsibly and respect applicable intellectual-property rights.", "Do not use automation that interferes with repository availability or security.", "A file may be temporarily unavailable when its stored PDF cannot be validated or delivered safely."] },
...
const privacy: LegalSection[] = [
  { title: "Retired Repository Updates", paragraphs: ["The PeAS Repository Updates newsletter has been discontinued. Signup and delivery are disabled, queued messages have been cancelled, and no further newsletter messages will be sent.", "Existing newsletter subscription and delivery records are inaccessible to the application and are retained temporarily only for the seven-day rollback window. After that window and verification of a restorable backup, the live records and newsletter schema will be deleted. Older encrypted backup copies will expire under the institutional backup-rotation schedule."], bullets: ["The Office of Research & Publications remains available for privacy questions and data-rights requests.", "Newsletter records are not used for any new purpose during the rollback window."] },
  { title: "What Information We Collect (and Why!)", paragraphs: ["PeAS collects only the information needed to operate, secure, and improve the repository. Public PDF downloads do not require a visitor to provide a name, email address, affiliation, or reason."], subheading: "Information You Provide Directly:", bullets: ["Communications: if you contact the Office of Research & Publications, PeAS retains the inquiry and its reference code.", "Retired newsletter records: previously supplied email addresses, consent records, and delivery preferences are held only for the temporary rollback window described above.", "Administrator records: explicitly provisioned administrators have authentication and audit records; visitors do not have accounts."] },
  ...
  { title: "Your Rights & Choices (You're in Control!)", paragraphs: ["You may contact the Office of Research & Publications to ask about personal information associated with a contact inquiry, a retired newsletter record, or an administrator account."], bullets: ["Request access to or correction of personal information you supplied.", "Request deletion where no institutional or legal retention requirement applies.", "Manage non-essential cookies through your browser settings."] },
