...
const privacy: LegalSection[] = [
  ...
  { title: "Your Rights & Choices (You're in Control!)", paragraphs: ["You may contact the Office of Research & Publications to ask about personal information associated with a contact inquiry, newsletter subscription, or administrator account."], bullets: ["Request access to or correction of personal information you supplied.", "Request deletion where no institutional or legal retention requirement applies.", "Manage newsletter preferences or unsubscribe using the link in an email.", "Manage non-essential cookies through your browser settings."] },
