...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay ref={ref} className={cn("peas-ui-dialog-overlay", className)} {...props} />
));
...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content ref={ref} className={cn("peas-ui-dialog-content", className)} {...props}>
      {children}
      {!hideClose ? (
        <DialogPrimitive.Close className="peas-ui-dialog-close" aria-label="Close dialog">
          <X aria-hidden="true" />
