...
const report = {
  ...
  activity: { sitePageViews: { total: 10, guest: 6, registered: 4 }, siteVisits: { total: 4, guest: 2, registered: 2 }, homePageViews: { total: 4, guest: 2, registered: 2 }, uploadedEntries: 0, repositoryViews: 8, repositoryDownloads: 2, guestRepositoryViews: 5, registeredRepositoryViews: 3, authorProfileViews: 4, topicWorkViews: 7, guestViews: 5, registeredViews: 3, approvedRequestDownloads: 0, activeRegisteredUsers: 1, activeRegisteredReaders: 1, homeVisits: { total: 4, guest: 2, registered: 2 } },
  ...
  distributions: { documentTypes: [{ label: "THESIS", count: 4 }], requestStatuses: [] }, registeredReaderSummary: { activeUsers: 1, views: 3, downloads: 1, averageInteractionsPerActiveUser: 4 }, metricDefinitions: { catalog_entries: "Current catalog entries", stored_documents: "Stored documents", site_page_views: "Page views", site_visits: "Visits", active_registered_readers: "Readers" },
};
...
const detail = {
  ...
  rows: [{ id: 1, key: "document:1", name: "A viewed thesis", title: "A viewed thesis", category: "THESIS", views: 8, downloads: 2, guestViews: 5, registeredViews: 3, approvedRequestDownloads: 0, workViews: 8, workDownloads: 2, publicWorks: 1, entryCount: 1, rank: 1, rankDelta: 1, percentChange: 100, href: "/pages/guest-single.html?id=1" }],
  pagination: { page: 1, pageSize: 25, total: 1, totalPages: 1 },
  filters: { documentTypes: ["THESIS"], topics: [{ id: 1, name: "Sustainability" }], departments: [], affiliations: [] },
  selected: { id: 1, key: "document:1", name: "A viewed thesis", title: "A viewed thesis", category: "THESIS", views: 8, downloads: 2, guestViews: 5, registeredViews: 3, approvedRequestDownloads: 0, workViews: 8, workDownloads: 2, publicWorks: 1, entryCount: 1, rank: 1, rankDelta: 1, percentChange: 100, series: [{ bucket: "2026-08-01T00:00:00.000Z", views: 8, downloads: 2, guestViews: 5, registeredViews: 3 }], href: "/pages/guest-single.html?id=1" },
};
